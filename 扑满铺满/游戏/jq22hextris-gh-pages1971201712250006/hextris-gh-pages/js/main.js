...
function showHelp() {
	...
	$("#inst_main_body").html("<div id = 'instructions_head'>如何玩</div><p>其目的是阻止块离开外部灰色六边形的内部。</p><p>" + (settings.platform != 'mobile' ? '按左右箭头键' : '点击屏幕的左右两侧') + 
	" 旋转六边形</p><p>清除块，并获得3个或更多的相同颜色触摸块获得点。</p><p>在你的连击条纹消失之前剩下的时间是由 <span style='color:#f1c40f;'>这个</span> <span style='color:#e74c3c'>有色的</span> <span style='color:#3498db'>线</span> <span style='color:#2ecc71'>在</span> 外六边形</p> <hr> <p id = 'afterhr'></p> 通过 ");
	if (gameState == 1) {
		pause();
	}
